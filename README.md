...
5. **Stress-test:** 1000 concurrent transaction requests, đảm bảo zero balance inconsistency nhờ cơ chế Pessimistic Locking và Idempotency. Kiểm chứng hệ thống trong môi trường high concurrency, đảm bảo tính nhất quán dữ liệu và không phát sinh race condition.
